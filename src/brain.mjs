...
const RUN_INTENT_SCHEMA = {
  ...
  fields: {
    ...
    goal_alignment_required: { type: "boolean" },
...
const GOAL_SCHEMA = {
  ...
  fields: {
    ...
    change_history: { type: "list", item_type: "string" },
    request_history: { type: "list", item_type: "string" },
...
function frontmatterToIntent(document) {
  ...
  return {
    ...
    goalAlignmentRequired: value.goal_alignment_required === true,
  ...
  return withBrainLock(`admit-${repo.key}`, async () => {
    ...
    try {
      ...
      const fields = {
        ...
        ...(goalAlignmentRequired ? { goal_alignment_required: true } : {}),
